...
<script>
  function deleteProduct(id){
    $.post( "http://localhost/kiemtraphp/controller/cms/product.php",{id:id,action:"delete"}, function( data ) {
      // console.log(data);
  ...
  function editProduct(id){
    $.post( "http://localhost/kiemtraphp/controller/cms/product.php",{id:id,action:"view-edit"}, function( data ) {
