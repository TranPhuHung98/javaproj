...
<body id="page-top">
	...
	<%
		...
		ArrayList<DotUngHoBean> dsDotUngHo = (ArrayList<DotUngHoBean>) request.getAttribute("dotuhs");
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link"
				href="AdminDotNhanUngHoController"> <i class="fas fa-fw fa-book"></i>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<form action="AdminDotUngHoController" method="post">
						<div class="form-group">
							<label>Mã đợt ủng hộ: </label> <input type="text"
								class="form-control" name="txtmaduh"
								value="<%=dotUngHo == null ? "" : dotUngHo.getMaDUH()%>">
							<label class="mt-3">Mã đơn vị: </label> <input type="text"
								class="form-control" name="txtmadvuh"
								value="<%=dotUngHo == null ? "" : dotUngHo.getMaDVUH()%>">
							<label class="mt-3">Ngày ủng hộ: </label> <input type="text"
								class="form-control" name="txtngayuh"
								value="<%=dotUngHo == null ? "" : dotUngHo.getNgayUH()%>">
							<label class="mt-3">Hình thức ủng hộ: </label> <input type="text"
								class="form-control" name="txthtuh"
								value="<%=chiTietDotUngHo == null ? "" : chiTietDotUngHo.getHinhThucUH()%>">
							<label class="mt-3">Số lượng ủng hộ: </label> <input type="text"
								class="form-control" name="txtsluh"
								value="<%=chiTietDotUngHo == null ? "" : chiTietDotUngHo.getSoLuongUH()%>">
							<label class="mt-3">Đơn vị tính: </label> <input type="text"
								class="form-control" name="txtdvt"
								value="<%=chiTietDotUngHo == null ? "" : chiTietDotUngHo.getDonViTinh()%>">
						</div>
						<button type="submit" class="btn btn-primary" name="btnAdd" value="1">Thêm</button>
						...
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered" id="dataTable" width="100%"
									...
									<tbody>
										<%
											for (DotUngHoBean dotuh : dsDotUngHo) {
										%>
										<tr>
											<td><%=dotuh.getMaDUH()%></td>

											<td><%=dotuh.getMaDVUH()%></td>

											<td><%=dotuh.getNgayUH() + ""%></td>



											<td><a
												href="AdminDotUngHoController?select=<%=dotuh.getMaDUH()%>"
												class="" title="Edit" data-toggle="tooltip"><i
													class="far fa-edit"></i> Edit</a> <a
												href="AdminDotUngHoController?delete=<%=dotuh.getMaDUH()%>"
